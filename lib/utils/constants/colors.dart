...
class AppColor {
  ...
  static Color get primaryText80 => const Color(0xffFFFFFF).withAlpha(204);

  static Color get primaryText60 => const Color(0xffFFFFFF).withAlpha(153);

  static Color get primaryText35 => const Color(0xffFFFFFF).withAlpha(135);

  static Color get primaryText28 => const Color(0xffFFFFFF).withAlpha(71);
